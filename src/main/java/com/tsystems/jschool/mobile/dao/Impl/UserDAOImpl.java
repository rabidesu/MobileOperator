...
public class UserDAOImpl extends GenericDAOImpl<User> implements UserDAO {
    ...
    public List<User> getUserByPhoneNumber(String number, EntityManager entityManager) throws MobileDAOException {
        try {
    ...
    public List<User> getUserByEmail(String email, EntityManager entityManager) throws MobileDAOException {
        try {
    ...
    public List<User> getUserBySurname(String surname, EntityManager entityManager) throws MobileDAOException {
        try {
