    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <form role="form" action="/pages/admin/ChangeContract" id="form-save-contract" method="post">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade in active" id="general">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" id="password" placeholder="Введите пароль" name="password" disabled value="${requestScope.contract.user.password}">
                                </div>
                        </div>
                ...
                <form action="/pages/admin/ChangeContract" id="form-block-contract" method="post">
                    <input type="hidden" name="contract_id" value="${requestScope.contract.id}">
                    <input type="hidden" name="block" value="block">
                </form>
                <form action="/pages/admin/ChangeContract" id="form-unblock-contract" method="post">
                    <input type="hidden" name="contract_id" value="${requestScope.contract.id}">
                    <input type="hidden" name="block" value="unblock">
                </form>
                <form action="/pages/admin/FindClientProfile" id="form-client-profile">
